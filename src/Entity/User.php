 ...
 * @UniqueEntity(
 * fields={"email"},
 * message="un autre utilisateur s'est déjà inscrit avec cette adresse e-mail, merci de la modifier"
 * )
 * 
 */
class User implements UserInterface
{
     ...
     * @Assert\Url(message="Veuillez donner une adresse valide pour votre avatar!")
     */
    private $picture;
